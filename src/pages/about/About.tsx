...
export default function About() {
  const images = [
    ...
    { id: '4', url: '/images/about/japan-daruma.jpg', alt: 'Temple, Japan', position: '90% 50%', aspectRatio: '1/1' },
    { id: '5', url: '/images/about/trentino.jpg', alt: 'Trentino', position: '0% 100%', aspectRatio: '4/3' },
    { id: '6', url: '/images/about/japan.jpg', alt: 'Image 6', position: '50% 50%', aspectRatio: '3/4' },
  ];
