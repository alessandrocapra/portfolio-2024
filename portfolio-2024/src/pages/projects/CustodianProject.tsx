import { TwoColumnsSection } from "../../components/layout"
import { ProjectHeader, ProjectHighlight } from "../../components/projects";
    ...
    <div>
      ...
      <TwoColumnsSection>
        <div className="max-w-prose">
          <h3 className="text-2xl font-medium">Concept</h3>
      ...
      <TwoColumnsSection reverse={true}>
        <div className="max-w-prose">
          <h3 className="text-2xl font-medium">Requirements, wireframes and UI</h3>
